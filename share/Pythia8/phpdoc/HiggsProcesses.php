...
<br/><br/><strong>HiggsSM:all</strong>  <input type="radio" name="6" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:ffbar2H</strong>  <input type="radio" name="7" value="on"><strong>On</strong>
<input type="radio" name="7" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^0</i>, where <i>f</i> sums over available 
...
<br/><br/><strong>HiggsSM:gg2H</strong>  <input type="radio" name="8" value="on"><strong>On</strong>
<input type="radio" name="8" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; H^0</i> via loop contributions primarily from 
top. 
Code 902. 
   
 
<br/><br/><strong>HiggsSM:gmgm2H</strong>  <input type="radio" name="9" value="on"><strong>On</strong>
<input type="radio" name="9" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>gamma gamma &rarr; H^0</i> via loop contributions primarily 
from top and <i>W</i>. 
Code 903. 
   
 
<br/><br/><strong>HiggsSM:ffbar2HZ</strong>  <input type="radio" name="10" value="on"><strong>On</strong>
<input type="radio" name="10" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^0 Z^0</i> via <i>s</i>-channel <i>Z^0</i> 
exchange. 
Code 904. 
   
 
<br/><br/><strong>HiggsSM:ffbar2HW</strong>  <input type="radio" name="11" value="on"><strong>On</strong>
<input type="radio" name="11" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^0 W^+-</i> via <i>s</i>-channel 
<i>W^+-</i> exchange. 
Code 905. 
   
 
<br/><br/><strong>HiggsSM:ff2Hff(t:ZZ)</strong>  <input type="radio" name="12" value="on"><strong>On</strong>
<input type="radio" name="12" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f f' &rarr; H^0 f f'</i> via <i>Z^0 Z^0</i> fusion. 
Code 906. 
   
 
<br/><br/><strong>HiggsSM:ff2Hff(t:WW)</strong>  <input type="radio" name="13" value="on"><strong>On</strong>
<input type="radio" name="13" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f_1 f_2 &rarr; H^0 f_3 f_4</i> via <i>W^+ W^-</i> fusion. 
Code 907. 
   
 
<br/><br/><strong>HiggsSM:gg2Httbar</strong>  <input type="radio" name="14" value="on"><strong>On</strong>
<input type="radio" name="14" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; H^0 t tbar</i> via <i>t tbar</i> fusion 
...
<br/><br/><strong>HiggsSM:qqbar2Httbar</strong>  <input type="radio" name="15" value="on"><strong>On</strong>
<input type="radio" name="15" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; H^0 t tbar</i> via <i>t tbar</i> fusion 
(or, alternatively put, Higgs radiation off a top line). 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
Code 909. 
...
a process like <i>b bbar &rarr; H^0</i> implies that a <i>b/bbar</i> 
is taken from each incoming hadron, leaving behind its respective 
antiparticle. The initial-state showers will then add one 
<i>g &rarr; b bbar</i> branching on either side, so that effectively 
the process becomes <i>g g &rarr; H0 b bbar</i>. This would be the 
same basic process as the <i>g g &rarr; H^0 t tbar</i> one used for top. 
...
<br/><br/><strong>HiggsSM:qg2Hq</strong>  <input type="radio" name="16" value="on"><strong>On</strong>
<input type="radio" name="16" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q g &rarr; H^0 q</i>. This process gives first-order 
corrections to the <i>f fbar &rarr; H^0</i> one above, and should only be 
used to study  the high-<i>pT</i> tail, while <i>f fbar &rarr; H^0</i> 
...
<i>q qbar &rarr; H^0 g</i>, which is not explicitly implemented here, 
...
<input type="radio" name="17" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; H^0 b bbar</i>. This process is yet one order 
higher of the <i>b bbar &rarr; H^0</i> and <i>b g &rarr; H^0 b</i> chain, 
...
<br/><br/><strong>HiggsSM:qqbar2Hbbbar</strong>  <input type="radio" name="18" value="on"><strong>On</strong>
<input type="radio" name="18" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; H^0 b bbar</i> via an <i>s</i>-channel 
...
to the <i>g g &rarr; H^0</i> process, again dominated by the top loop. 
...
finite-top-mass coupling in <i>g g &rarr; H^0</i>. (Complete loop 
...
<input type="radio" name="19" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; H^0 g</i> via loop contributions primarily 
from top. 
Code 914. 
...
<input type="radio" name="20" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q g &rarr; H^0 q</i> via loop contributions primarily 
...
<input type="radio" name="21" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; H^0 g</i> via an <i>s</i>-channel gluon 
and loop contributions primarily from top. Is strictly speaking a 
"new" process, not directly derived from <i>g g &rarr; H^0</i>, and 
...
<br/><br/><strong>Higgs:useBSM</strong>  <input type="radio" name="22" value="on"><strong>On</strong>
...
a process such as <i>q qbar &rarr; A^0 Z^0</i>, which otherwise is 
forbidden. However, note that the loop integrals e.g. for 
<i>g g &rarr; h^0/H^0/A^0</i> are hardcoded to be for scalars for the 
...
<br/><br/><strong>HiggsBSM:all</strong>  <input type="radio" name="23" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:allH1</strong>  <input type="radio" name="24" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:ffbar2H1</strong>  <input type="radio" name="25" value="on"><strong>On</strong>
<input type="radio" name="25" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; h^0(H_1^0)</i>, where <i>f</i> sums over 
available flavours except top. 
Code 1001. 
   
 
<br/><br/><strong>HiggsBSM:gg2H1</strong>  <input type="radio" name="26" value="on"><strong>On</strong>
<input type="radio" name="26" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; h^0(H_1^0)</i> via loop contributions primarily 
from top. 
Code 1002. 
   
 
<br/><br/><strong>HiggsBSM:gmgm2H1</strong>  <input type="radio" name="27" value="on"><strong>On</strong>
<input type="radio" name="27" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>gamma gamma &rarr; h^0(H_1^0)</i> via loop contributions 
primarily from top and <i>W</i>. 
Code 1003. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H1Z</strong>  <input type="radio" name="28" value="on"><strong>On</strong>
<input type="radio" name="28" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; h^0(H_1^0) Z^0</i> via <i>s</i>-channel 
<i>Z^0</i> exchange. 
Code 1004. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H1W</strong>  <input type="radio" name="29" value="on"><strong>On</strong>
<input type="radio" name="29" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; h^0(H_1^0) W^+-</i> via <i>s</i>-channel 
<i>W^+-</i> exchange. 
Code 1005. 
   
 
<br/><br/><strong>HiggsBSM:ff2H1ff(t:ZZ)</strong>  <input type="radio" name="30" value="on"><strong>On</strong>
<input type="radio" name="30" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f f' &rarr; h^0(H_1^0) f f'</i> via <i>Z^0 Z^0</i> fusion. 
Code 1006. 
   
 
<br/><br/><strong>HiggsBSM:ff2H1ff(t:WW)</strong>  <input type="radio" name="31" value="on"><strong>On</strong>
<input type="radio" name="31" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f_1 f_2 &rarr; h^0(H_1^0) f_3 f_4</i> via <i>W^+ W^-</i> 
fusion. 
Code 1007. 
   
 
<br/><br/><strong>HiggsBSM:gg2H1ttbar</strong>  <input type="radio" name="32" value="on"><strong>On</strong>
<input type="radio" name="32" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; h^0(H_1^0) t tbar</i> via <i>t tbar</i> fusion 
(or, alternatively put, Higgs radiation off a top line). 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
Code 1008. 
...
<br/><br/><strong>HiggsBSM:qqbar2H1ttbar</strong>  <input type="radio" name="33" value="on"><strong>On</strong>
<input type="radio" name="33" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; h^0(H_1^0) t tbar</i> via <i>t tbar</i> 
...
<br/><br/><strong>HiggsBSM:allH2</strong>  <input type="radio" name="34" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:ffbar2H2</strong>  <input type="radio" name="35" value="on"><strong>On</strong>
<input type="radio" name="35" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^0(H_2^0)</i>, where <i>f</i> sums over 
available flavours except top. 
Code 1021. 
   
 
<br/><br/><strong>HiggsBSM:gg2H2</strong>  <input type="radio" name="36" value="on"><strong>On</strong>
<input type="radio" name="36" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; H^0(H_2^0)</i> via loop contributions primarily 
from top. 
Code 1022. 
   
 
<br/><br/><strong>HiggsBSM:gmgm2H2</strong>  <input type="radio" name="37" value="on"><strong>On</strong>
<input type="radio" name="37" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>gamma gamma &rarr; H^0(H_2^0)</i> via loop contributions 
primarily from top and <i>W</i>. 
Code 1023. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H2Z</strong>  <input type="radio" name="38" value="on"><strong>On</strong>
<input type="radio" name="38" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^0(H_2^0) Z^0</i> via <i>s</i>-channel 
<i>Z^0</i> exchange. 
Code 1024. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H2W</strong>  <input type="radio" name="39" value="on"><strong>On</strong>
<input type="radio" name="39" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^0(H_2^0) W^+-</i> via <i>s</i>-channel 
<i>W^+-</i> exchange. 
Code 1025. 
   
 
<br/><br/><strong>HiggsBSM:ff2H2ff(t:ZZ)</strong>  <input type="radio" name="40" value="on"><strong>On</strong>
<input type="radio" name="40" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f f' &rarr; H^0(H_2^0) f f'</i> via <i>Z^0 Z^0</i> fusion. 
Code 1026. 
   
 
<br/><br/><strong>HiggsBSM:ff2H2ff(t:WW)</strong>  <input type="radio" name="41" value="on"><strong>On</strong>
<input type="radio" name="41" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f_1 f_2 &rarr; H^0(H_2^0) f_3 f_4</i> via <i>W^+ W^-</i> 
fusion. 
Code 1027. 
   
 
<br/><br/><strong>HiggsBSM:gg2H2ttbar</strong>  <input type="radio" name="42" value="on"><strong>On</strong>
<input type="radio" name="42" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; H^0(H_2^0) t tbar</i> via <i>t tbar</i> fusion 
(or, alternatively put, Higgs radiation off a top line). 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
Code 1028. 
...
<br/><br/><strong>HiggsBSM:qqbar2H2ttbar</strong>  <input type="radio" name="43" value="on"><strong>On</strong>
<input type="radio" name="43" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; H^0(H_2^0) t tbar</i> via <i>t tbar</i> 
fusion (or, alternatively put, Higgs radiation off a top line). 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
Code 1029. 
...
<br/><br/><strong>HiggsBSM:allA3</strong>  <input type="radio" name="44" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:ffbar2A3</strong>  <input type="radio" name="45" value="on"><strong>On</strong>
<input type="radio" name="45" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; A^0(H_3^0)</i>, where <i>f</i> sums over 
available flavours except top. 
Code 1041. 
   
 
<br/><br/><strong>HiggsBSM:gg2A3</strong>  <input type="radio" name="46" value="on"><strong>On</strong>
<input type="radio" name="46" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; A^0(A_3^0)</i> via loop contributions primarily 
from top. 
Code 1042. 
   
 
<br/><br/><strong>HiggsBSM:gmgm2A3</strong>  <input type="radio" name="47" value="on"><strong>On</strong>
<input type="radio" name="47" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>gamma gamma &rarr; A^0(A_3^0)</i> via loop contributions 
primarily from top and <i>W</i>. 
Code 1043. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2A3Z</strong>  <input type="radio" name="48" value="on"><strong>On</strong>
<input type="radio" name="48" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; A^0(A_3^0) Z^0</i> via <i>s</i>-channel 
<i>Z^0</i> exchange. 
Code 1044. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2A3W</strong>  <input type="radio" name="49" value="on"><strong>On</strong>
<input type="radio" name="49" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; A^0(A_3^0) W^+-</i> via <i>s</i>-channel 
<i>W^+-</i> exchange. 
Code 1045. 
   
 
<br/><br/><strong>HiggsBSM:ff2A3ff(t:ZZ)</strong>  <input type="radio" name="50" value="on"><strong>On</strong>
<input type="radio" name="50" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f f' &rarr; A^0(A_3^0) f f'</i> via <i>Z^0 Z^0</i> fusion. 
Code 1046. 
   
 
<br/><br/><strong>HiggsBSM:ff2A3ff(t:WW)</strong>  <input type="radio" name="51" value="on"><strong>On</strong>
<input type="radio" name="51" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f_1 f_2 &rarr; A^0(A_3^0) f_3 f_4</i> via <i>W^+ W^-</i> 
fusion. Code 1047. 
   
 
<br/><br/><strong>HiggsBSM:gg2A3ttbar</strong>  <input type="radio" name="52" value="on"><strong>On</strong>
<input type="radio" name="52" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; A^0(A_3^0) t tbar</i> via <i>t tbar</i> fusion 
(or, alternatively put, Higgs radiation off a top line). 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
Code 1048. 
...
<br/><br/><strong>HiggsBSM:qqbar2A3ttbar</strong>  <input type="radio" name="53" value="on"><strong>On</strong>
<input type="radio" name="53" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; A^0(A_3^0) t tbar</i> via <i>t tbar</i> 
fusion (or, alternatively put, Higgs radiation off a top line). 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
Code 1049. 
...
<br/><br/><strong>HiggsBSM:allH+-</strong>  <input type="radio" name="54" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:ffbar2H+-</strong>  <input type="radio" name="55" value="on"><strong>On</strong>
<input type="radio" name="55" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar' &rarr; H^+-</i>, where <i>f, fbar'</i> sums over 
available incoming flavours. Since couplings are assumed 
generation-diagonal, in practice this means <i>c sbar &rarr; H^+</i> 
and <i>s cbar &rarr; H^-</i>. 
Code 1061. 
   
 
<br/><br/><strong>HiggsBSM:bg2H+-t</strong>  <input type="radio" name="56" value="on"><strong>On</strong>
<input type="radio" name="56" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>b g &rarr; H^+ tbar</i>. At hadron colliders this is the 
...
<br/><br/><strong>HiggsBSM:allHpair</strong>  <input type="radio" name="57" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:ffbar2A3H1</strong>  <input type="radio" name="58" value="on"><strong>On</strong>
<input type="radio" name="58" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; A^0(H_3) h^0(H_1)</i>. 
Code 1081. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2A3H2</strong>  <input type="radio" name="59" value="on"><strong>On</strong>
<input type="radio" name="59" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; A^0(H_3) H^0(H_2)</i>. 
Code 1082. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H+-H1</strong>  <input type="radio" name="60" value="on"><strong>On</strong>
<input type="radio" name="60" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^+- h^0(H_1)</i>. 
Code 1083. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H+-H2</strong>  <input type="radio" name="61" value="on"><strong>On</strong>
<input type="radio" name="61" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H^+- H^0(H_2)</i>. 
Code 1084. 
   
 
<br/><br/><strong>HiggsBSM:ffbar2H+H-</strong>  <input type="radio" name="62" value="on"><strong>On</strong>
<input type="radio" name="62" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>f fbar &rarr; H+ H-</i>. 
Code 1085. 
...
<br/><br/><strong>HiggsBSM:qg2H1q</strong>  <input type="radio" name="63" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:gg2H1bbbar</strong>  <input type="radio" name="64" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:qqbar2H1bbbar</strong>  <input type="radio" name="65" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:qg2H2q</strong>  <input type="radio" name="69" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:gg2H2bbbar</strong>  <input type="radio" name="70" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:qqbar2H2bbbar</strong>  <input type="radio" name="71" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:qg2A3q</strong>  <input type="radio" name="75" value="on"><strong>On</strong>
<input type="radio" name="75" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q g &rarr; A^0 q</i>. This process gives first-order 
corrections to the <i>f fbar &rarr; A^0</i> one above, and should only be 
used to study  the high-<i>pT</i> tail, while <i>f fbar &rarr; A^0</i> 
should be used for inclusive production. Only the dominant <i>c</i> 
and <i>b</i> contributions are included, and generated separately 
for technical reasons. Note that another first-order process would be 
<i>q qbar &rarr; A^0 g</i>, which is not explicitly implemented here, 
but is obtained from showering off the lowest-order process. It does not 
contain any <i>b</i> at large <i>pT</i>, however, so is less 
interesting for many applications. 
Code 1051. 
...
<br/><br/><strong>HiggsBSM:gg2A3bbbar</strong>  <input type="radio" name="76" value="on"><strong>On</strong>
<input type="radio" name="76" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; A^0 b bbar</i>. This process is yet one order 
higher of the <i>b bbar &rarr; A^0</i> and <i>b g &rarr; A^0 b</i> chain, 
where now two quarks should be required above some large <i>pT</i> 
threshold. 
Warning: unfortunately this process is rather slow, owing to a 
lengthy cross-section expression and inefficient phase-space selection. 
...
<br/><br/><strong>HiggsBSM:qqbar2A3bbbar</strong>  <input type="radio" name="77" value="on"><strong>On</strong>
<input type="radio" name="77" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; A^0 b bbar</i> via an <i>s</i>-channel 
gluon, so closely related to the previous one, but typically less 
important owing to the smaller rate of (anti)quarks relative to 
gluons. 
Warning: unfortunately this process is rather slow, owing to a 
...
<input type="radio" name="78" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>g g &rarr; A^0 g</i> via loop contributions primarily 
from top. 
Code 1054. 
...
<input type="radio" name="79" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q g &rarr; A^0 q</i> via loop contributions primarily 
from top. Not to be confused with the <code>HiggsBSM:qg2H1q</code> 
process above, with its direct fermion-to-Higgs coupling. 
Code 1055. 
...
<input type="radio" name="80" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Scattering <i>q qbar &rarr; A^0 g</i> via an <i>s</i>-channel gluon 
and loop contributions primarily from top. Is strictly speaking a 
"new" process, not directly derived from <i>g g &rarr; A^0</i>, and 
could therefore be included in the standard mix without double-counting, 
but is numerically negligible. 
Code 1056. 
...
i.e. the coupling for <i>A^0 &rarr; H^0 Z^0</i> obviously is also valid 
for <i>H^0 &rarr; A^0 Z^0</i> and <i>Z^0 &rarr; H^0 A^0</i>. 
Note that couplings usually appear quadratically in matrix elements. 
 
<br/><br/><table><tr><td><strong>HiggsH1:coup2d </td><td></td><td> <input type="text" name="81" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>h^0(H_1^0)</i> coupling to down-type quarks. 
   
 
<br/><br/><table><tr><td><strong>HiggsH1:coup2u </td><td></td><td> <input type="text" name="82" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>h^0(H_1^0)</i> coupling to up-type quarks. 
   
 
<br/><br/><table><tr><td><strong>HiggsH1:coup2l </td><td></td><td> <input type="text" name="83" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>h^0(H_1^0)</i> coupling to (charged) leptons. 
   
 
<br/><br/><table><tr><td><strong>HiggsH1:coup2Z </td><td></td><td> <input type="text" name="84" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>h^0(H_1^0)</i> coupling to <i>Z^0</i>. 
   
 
<br/><br/><table><tr><td><strong>HiggsH1:coup2W </td><td></td><td> <input type="text" name="85" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>h^0(H_1^0)</i> coupling to <i>W^+-</i>. 
   
 
<br/><br/><table><tr><td><strong>HiggsH1:coup2Hchg </td><td></td><td> <input type="text" name="86" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>h^0(H_1^0)</i> coupling to <i>H^+-</i> (in loops). 
Is <i>sin(beta - alpha) + cos(2 beta) sin(beta + alpha) / 
(2 cos^2theta_W)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2d </td><td></td><td> <input type="text" name="87" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to down-type quarks. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2u </td><td></td><td> <input type="text" name="88" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to up-type quarks. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2l </td><td></td><td> <input type="text" name="89" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to (charged) leptons. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2Z </td><td></td><td> <input type="text" name="90" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to <i>Z^0</i>. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2W </td><td></td><td> <input type="text" name="91" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to <i>W^+-</i>. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2Hchg </td><td></td><td> <input type="text" name="92" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to <i>H^+-</i> (in loops). 
Is <i>cos(beta - alpha) + cos(2 beta) cos(beta + alpha) / 
(2 cos^2theta_W)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2H1H1 </td><td></td><td> <input type="text" name="93" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
...
<br/><br/><table><tr><td><strong>HiggsH2:coup2A3A3 </td><td></td><td> <input type="text" name="94" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to an <i>A^0(H_3^0)</i> pair. 
Is <i>cos(2 beta) cos(beta + alpha)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2H1Z </td><td></td><td> <input type="text" name="95" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to a <i>h^0(H_1^0) Z^0</i> pair. 
Vanishes in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2A3H1 </td><td></td><td> <input type="text" name="96" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to an <i>A^0(H_3^0) h^0(H_1^0)</i> pair. 
Vanishes in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsH2:coup2HchgW </td><td></td><td> <input type="text" name="97" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>H^0(H_2^0)</i> coupling to a <i>H^+- W-+</i> pair. 
Is <i>sin(beta - alpha)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2d </td><td></td><td> <input type="text" name="98" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to down-type quarks. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2u </td><td></td><td> <input type="text" name="99" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to up-type quarks. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2l </td><td></td><td> <input type="text" name="100" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to (charged) leptons. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2H1Z </td><td></td><td> <input type="text" name="101" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to a <i>h^0(H_1^0) Z^0</i> pair. 
Is <i>cos(beta - alpha)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2H2Z </td><td></td><td> <input type="text" name="102" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to a <i>H^0(H_2^0) Z^0</i> pair. 
Is <i>sin(beta - alpha)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2Z </td><td></td><td> <input type="text" name="103" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to <i>Z^0</i>. 
Vanishes in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2W </td><td></td><td> <input type="text" name="104" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to <i>W^+-</i>. 
Vanishes in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2H1H1 </td><td></td><td> <input type="text" name="105" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to a <i>h^0(H_1^0)</i> pair. 
Vanishes in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2Hchg </td><td></td><td> <input type="text" name="106" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to <i>H^+-</i>. 
Vanishes in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsA3:coup2HchgW </td><td></td><td> <input type="text" name="107" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>A^0(H_3^0)</i> coupling to a <i>H^+- W-+</i> pair. 
Is 1 in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsHchg:tanBeta </td><td></td><td> <input type="text" name="108" value="5." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>5.</strong></code>)</td></tr></table>
...
<br/><br/><table><tr><td><strong>HiggsHchg:coup2H1W </td><td></td><td> <input type="text" name="109" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
The <i>H^+-</i> coupling to a <i>h^0(H_1^0) W^+-</i> pair. 
Is <i>cos(beta - alpha)</i> in the MSSM. 
   
 
<br/><br/><table><tr><td><strong>HiggsHchg:coup2H2W </td><td></td><td> <input type="text" name="110" value="0." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.</strong></code>)</td></tr></table>
...
if($_POST["5"] != "on")
{
$data = "HiggsSM:NLOWidths = ".$_POST["5"]."\n";
fwrite($handle,$data);
}
if($_POST["6"] != "off")
{
$data = "HiggsSM:all = ".$_POST["6"]."\n";
fwrite($handle,$data);
}
if($_POST["7"] != "off")
{
$data = "HiggsSM:ffbar2H = ".$_POST["7"]."\n";
fwrite($handle,$data);
}
if($_POST["8"] != "off")
{
$data = "HiggsSM:gg2H = ".$_POST["8"]."\n";
fwrite($handle,$data);
}
if($_POST["9"] != "off")
{
$data = "HiggsSM:gmgm2H = ".$_POST["9"]."\n";
fwrite($handle,$data);
}
if($_POST["10"] != "off")
{
$data = "HiggsSM:ffbar2HZ = ".$_POST["10"]."\n";
fwrite($handle,$data);
}
if($_POST["11"] != "off")
{
$data = "HiggsSM:ffbar2HW = ".$_POST["11"]."\n";
fwrite($handle,$data);
}
if($_POST["12"] != "off")
{
$data = "HiggsSM:ff2Hff(t:ZZ) = ".$_POST["12"]."\n";
fwrite($handle,$data);
}
if($_POST["13"] != "off")
{
$data = "HiggsSM:ff2Hff(t:WW) = ".$_POST["13"]."\n";
fwrite($handle,$data);
}
if($_POST["14"] != "off")
{
$data = "HiggsSM:gg2Httbar = ".$_POST["14"]."\n";
fwrite($handle,$data);
}
if($_POST["15"] != "off")
{
$data = "HiggsSM:qqbar2Httbar = ".$_POST["15"]."\n";
fwrite($handle,$data);
}
if($_POST["16"] != "off")
{
$data = "HiggsSM:qg2Hq = ".$_POST["16"]."\n";
fwrite($handle,$data);
}
if($_POST["17"] != "off")
{
$data = "HiggsSM:gg2Hbbbar = ".$_POST["17"]."\n";
fwrite($handle,$data);
}
if($_POST["18"] != "off")
{
$data = "HiggsSM:qqbar2Hbbbar = ".$_POST["18"]."\n";
fwrite($handle,$data);
}
if($_POST["19"] != "off")
{
$data = "HiggsSM:gg2Hg(l:t) = ".$_POST["19"]."\n";
fwrite($handle,$data);
}
if($_POST["20"] != "off")
{
$data = "HiggsSM:qg2Hq(l:t) = ".$_POST["20"]."\n";
fwrite($handle,$data);
}
if($_POST["21"] != "off")
{
$data = "HiggsSM:qqbar2Hg(l:t) = ".$_POST["21"]."\n";
fwrite($handle,$data);
}
if($_POST["22"] != "off")
{
$data = "Higgs:useBSM = ".$_POST["22"]."\n";
fwrite($handle,$data);
}
if($_POST["23"] != "off")
{
$data = "HiggsBSM:all = ".$_POST["23"]."\n";
fwrite($handle,$data);
}
if($_POST["24"] != "off")
{
$data = "HiggsBSM:allH1 = ".$_POST["24"]."\n";
fwrite($handle,$data);
}
if($_POST["25"] != "off")
{
$data = "HiggsBSM:ffbar2H1 = ".$_POST["25"]."\n";
fwrite($handle,$data);
}
if($_POST["26"] != "off")
{
$data = "HiggsBSM:gg2H1 = ".$_POST["26"]."\n";
fwrite($handle,$data);
}
if($_POST["27"] != "off")
{
$data = "HiggsBSM:gmgm2H1 = ".$_POST["27"]."\n";
fwrite($handle,$data);
}
if($_POST["28"] != "off")
{
$data = "HiggsBSM:ffbar2H1Z = ".$_POST["28"]."\n";
fwrite($handle,$data);
}
if($_POST["29"] != "off")
{
$data = "HiggsBSM:ffbar2H1W = ".$_POST["29"]."\n";
fwrite($handle,$data);
}
if($_POST["30"] != "off")
{
$data = "HiggsBSM:ff2H1ff(t:ZZ) = ".$_POST["30"]."\n";
fwrite($handle,$data);
}
if($_POST["31"] != "off")
{
$data = "HiggsBSM:ff2H1ff(t:WW) = ".$_POST["31"]."\n";
fwrite($handle,$data);
}
if($_POST["32"] != "off")
{
$data = "HiggsBSM:gg2H1ttbar = ".$_POST["32"]."\n";
fwrite($handle,$data);
}
if($_POST["33"] != "off")
{
$data = "HiggsBSM:qqbar2H1ttbar = ".$_POST["33"]."\n";
fwrite($handle,$data);
}
if($_POST["34"] != "off")
{
$data = "HiggsBSM:allH2 = ".$_POST["34"]."\n";
fwrite($handle,$data);
}
if($_POST["35"] != "off")
{
$data = "HiggsBSM:ffbar2H2 = ".$_POST["35"]."\n";
fwrite($handle,$data);
}
if($_POST["36"] != "off")
{
$data = "HiggsBSM:gg2H2 = ".$_POST["36"]."\n";
fwrite($handle,$data);
}
if($_POST["37"] != "off")
{
$data = "HiggsBSM:gmgm2H2 = ".$_POST["37"]."\n";
fwrite($handle,$data);
}
if($_POST["38"] != "off")
{
$data = "HiggsBSM:ffbar2H2Z = ".$_POST["38"]."\n";
fwrite($handle,$data);
}
if($_POST["39"] != "off")
{
$data = "HiggsBSM:ffbar2H2W = ".$_POST["39"]."\n";
fwrite($handle,$data);
}
if($_POST["40"] != "off")
{
$data = "HiggsBSM:ff2H2ff(t:ZZ) = ".$_POST["40"]."\n";
fwrite($handle,$data);
}
if($_POST["41"] != "off")
{
$data = "HiggsBSM:ff2H2ff(t:WW) = ".$_POST["41"]."\n";
fwrite($handle,$data);
}
if($_POST["42"] != "off")
{
$data = "HiggsBSM:gg2H2ttbar = ".$_POST["42"]."\n";
fwrite($handle,$data);
}
if($_POST["43"] != "off")
{
$data = "HiggsBSM:qqbar2H2ttbar = ".$_POST["43"]."\n";
fwrite($handle,$data);
}
if($_POST["44"] != "off")
{
$data = "HiggsBSM:allA3 = ".$_POST["44"]."\n";
fwrite($handle,$data);
}
if($_POST["45"] != "off")
{
$data = "HiggsBSM:ffbar2A3 = ".$_POST["45"]."\n";
fwrite($handle,$data);
}
if($_POST["46"] != "off")
{
$data = "HiggsBSM:gg2A3 = ".$_POST["46"]."\n";
fwrite($handle,$data);
}
if($_POST["47"] != "off")
{
$data = "HiggsBSM:gmgm2A3 = ".$_POST["47"]."\n";
fwrite($handle,$data);
}
if($_POST["48"] != "off")
{
$data = "HiggsBSM:ffbar2A3Z = ".$_POST["48"]."\n";
fwrite($handle,$data);
}
if($_POST["49"] != "off")
{
$data = "HiggsBSM:ffbar2A3W = ".$_POST["49"]."\n";
fwrite($handle,$data);
}
if($_POST["50"] != "off")
{
$data = "HiggsBSM:ff2A3ff(t:ZZ) = ".$_POST["50"]."\n";
fwrite($handle,$data);
}
if($_POST["51"] != "off")
{
$data = "HiggsBSM:ff2A3ff(t:WW) = ".$_POST["51"]."\n";
fwrite($handle,$data);
}
if($_POST["52"] != "off")
{
$data = "HiggsBSM:gg2A3ttbar = ".$_POST["52"]."\n";
fwrite($handle,$data);
}
if($_POST["53"] != "off")
{
$data = "HiggsBSM:qqbar2A3ttbar = ".$_POST["53"]."\n";
fwrite($handle,$data);
}
if($_POST["54"] != "off")
{
$data = "HiggsBSM:allH+- = ".$_POST["54"]."\n";
fwrite($handle,$data);
}
if($_POST["55"] != "off")
{
$data = "HiggsBSM:ffbar2H+- = ".$_POST["55"]."\n";
fwrite($handle,$data);
}
if($_POST["56"] != "off")
{
$data = "HiggsBSM:bg2H+-t = ".$_POST["56"]."\n";
fwrite($handle,$data);
}
if($_POST["57"] != "off")
{
$data = "HiggsBSM:allHpair = ".$_POST["57"]."\n";
fwrite($handle,$data);
}
if($_POST["58"] != "off")
{
$data = "HiggsBSM:ffbar2A3H1 = ".$_POST["58"]."\n";
fwrite($handle,$data);
}
if($_POST["59"] != "off")
{
$data = "HiggsBSM:ffbar2A3H2 = ".$_POST["59"]."\n";
fwrite($handle,$data);
}
if($_POST["60"] != "off")
{
$data = "HiggsBSM:ffbar2H+-H1 = ".$_POST["60"]."\n";
fwrite($handle,$data);
}
if($_POST["61"] != "off")
{
$data = "HiggsBSM:ffbar2H+-H2 = ".$_POST["61"]."\n";
fwrite($handle,$data);
}
if($_POST["62"] != "off")
{
$data = "HiggsBSM:ffbar2H+H- = ".$_POST["62"]."\n";
fwrite($handle,$data);
}
if($_POST["63"] != "off")
{
$data = "HiggsBSM:qg2H1q = ".$_POST["63"]."\n";
fwrite($handle,$data);
}
if($_POST["64"] != "off")
{
$data = "HiggsBSM:gg2H1bbbar = ".$_POST["64"]."\n";
fwrite($handle,$data);
}
if($_POST["65"] != "off")
{
$data = "HiggsBSM:qqbar2H1bbbar = ".$_POST["65"]."\n";
fwrite($handle,$data);
}
if($_POST["66"] != "off")
{
$data = "HiggsBSM:gg2H1g(l:t) = ".$_POST["66"]."\n";
fwrite($handle,$data);
}
if($_POST["67"] != "off")
{
$data = "HiggsBSM:qg2H1q(l:t) = ".$_POST["67"]."\n";
fwrite($handle,$data);
}
if($_POST["68"] != "off")
{
$data = "HiggsBSM:qqbar2H1g(l:t) = ".$_POST["68"]."\n";
fwrite($handle,$data);
}
if($_POST["69"] != "off")
{
$data = "HiggsBSM:qg2H2q = ".$_POST["69"]."\n";
fwrite($handle,$data);
}
if($_POST["70"] != "off")
{
$data = "HiggsBSM:gg2H2bbbar = ".$_POST["70"]."\n";
fwrite($handle,$data);
}
if($_POST["71"] != "off")
{
$data = "HiggsBSM:qqbar2H2bbbar = ".$_POST["71"]."\n";
fwrite($handle,$data);
}
if($_POST["72"] != "off")
{
$data = "HiggsBSM:gg2H2g(l:t) = ".$_POST["72"]."\n";
fwrite($handle,$data);
}
if($_POST["73"] != "off")
{
$data = "HiggsBSM:qg2H2q(l:t) = ".$_POST["73"]."\n";
fwrite($handle,$data);
}
if($_POST["74"] != "off")
{
$data = "HiggsBSM:qqbar2H2g(l:t) = ".$_POST["74"]."\n";
fwrite($handle,$data);
}
if($_POST["75"] != "off")
{
$data = "HiggsBSM:qg2A3q = ".$_POST["75"]."\n";
fwrite($handle,$data);
}
if($_POST["76"] != "off")
{
$data = "HiggsBSM:gg2A3bbbar = ".$_POST["76"]."\n";
fwrite($handle,$data);
}
if($_POST["77"] != "off")
{
$data = "HiggsBSM:qqbar2A3bbbar = ".$_POST["77"]."\n";
fwrite($handle,$data);
}
if($_POST["78"] != "off")
{
$data = "HiggsBSM:gg2A3g(l:t) = ".$_POST["78"]."\n";
fwrite($handle,$data);
}
if($_POST["79"] != "off")
{
$data = "HiggsBSM:qg2A3q(l:t) = ".$_POST["79"]."\n";
fwrite($handle,$data);
}
if($_POST["80"] != "off")
{
$data = "HiggsBSM:qqbar2A3g(l:t) = ".$_POST["80"]."\n";
fwrite($handle,$data);
}
if($_POST["81"] != "1.")
{
$data = "HiggsH1:coup2d = ".$_POST["81"]."\n";
fwrite($handle,$data);
}
if($_POST["82"] != "1.")
{
$data = "HiggsH1:coup2u = ".$_POST["82"]."\n";
fwrite($handle,$data);
}
if($_POST["83"] != "1.")
{
$data = "HiggsH1:coup2l = ".$_POST["83"]."\n";
fwrite($handle,$data);
}
if($_POST["84"] != "1.")
{
$data = "HiggsH1:coup2Z = ".$_POST["84"]."\n";
fwrite($handle,$data);
}
if($_POST["85"] != "1.")
{
$data = "HiggsH1:coup2W = ".$_POST["85"]."\n";
fwrite($handle,$data);
}
if($_POST["86"] != "0.")
{
$data = "HiggsH1:coup2Hchg = ".$_POST["86"]."\n";
fwrite($handle,$data);
}
if($_POST["87"] != "1.")
{
$data = "HiggsH2:coup2d = ".$_POST["87"]."\n";
fwrite($handle,$data);
}
if($_POST["88"] != "1.")
{
$data = "HiggsH2:coup2u = ".$_POST["88"]."\n";
fwrite($handle,$data);
}
if($_POST["89"] != "1.")
{
$data = "HiggsH2:coup2l = ".$_POST["89"]."\n";
fwrite($handle,$data);
}
if($_POST["90"] != "1.")
{
$data = "HiggsH2:coup2Z = ".$_POST["90"]."\n";
fwrite($handle,$data);
}
if($_POST["91"] != "1.")
{
$data = "HiggsH2:coup2W = ".$_POST["91"]."\n";
fwrite($handle,$data);
}
if($_POST["92"] != "0.")
{
$data = "HiggsH2:coup2Hchg = ".$_POST["92"]."\n";
fwrite($handle,$data);
}
if($_POST["93"] != "1.")
{
$data = "HiggsH2:coup2H1H1 = ".$_POST["93"]."\n";
fwrite($handle,$data);
}
if($_POST["94"] != "1.")
{
$data = "HiggsH2:coup2A3A3 = ".$_POST["94"]."\n";
fwrite($handle,$data);
}
if($_POST["95"] != "0.")
{
$data = "HiggsH2:coup2H1Z = ".$_POST["95"]."\n";
fwrite($handle,$data);
}
if($_POST["96"] != "0.")
{
$data = "HiggsH2:coup2A3H1 = ".$_POST["96"]."\n";
fwrite($handle,$data);
}
if($_POST["97"] != "0.")
{
$data = "HiggsH2:coup2HchgW = ".$_POST["97"]."\n";
fwrite($handle,$data);
}
if($_POST["98"] != "1.")
{
$data = "HiggsA3:coup2d = ".$_POST["98"]."\n";
fwrite($handle,$data);
}
if($_POST["99"] != "1.")
{
$data = "HiggsA3:coup2u = ".$_POST["99"]."\n";
fwrite($handle,$data);
}
if($_POST["100"] != "1.")
{
$data = "HiggsA3:coup2l = ".$_POST["100"]."\n";
fwrite($handle,$data);
}
if($_POST["101"] != "1.")
{
$data = "HiggsA3:coup2H1Z = ".$_POST["101"]."\n";
fwrite($handle,$data);
}
if($_POST["102"] != "1.")
{
$data = "HiggsA3:coup2H2Z = ".$_POST["102"]."\n";
fwrite($handle,$data);
}
if($_POST["103"] != "0.")
{
$data = "HiggsA3:coup2Z = ".$_POST["103"]."\n";
fwrite($handle,$data);
}
if($_POST["104"] != "0.")
{
$data = "HiggsA3:coup2W = ".$_POST["104"]."\n";
fwrite($handle,$data);
}
if($_POST["105"] != "0.")
{
$data = "HiggsA3:coup2H1H1 = ".$_POST["105"]."\n";
fwrite($handle,$data);
}
if($_POST["106"] != "0.")
{
$data = "HiggsA3:coup2Hchg = ".$_POST["106"]."\n";
fwrite($handle,$data);
}
if($_POST["107"] != "1.")
{
$data = "HiggsA3:coup2HchgW = ".$_POST["107"]."\n";
fwrite($handle,$data);
}
if($_POST["108"] != "5.")
{
$data = "HiggsHchg:tanBeta = ".$_POST["108"]."\n";
fwrite($handle,$data);
}
if($_POST["109"] != "1.")
{
$data = "HiggsHchg:coup2H1W = ".$_POST["109"]."\n";
fwrite($handle,$data);
}
if($_POST["110"] != "0.")
{
$data = "HiggsHchg:coup2H2W = ".$_POST["110"]."\n";
fwrite($handle,$data);
}
if($_POST["111"] != "1")
{
$data = "HiggsH1:parity = ".$_POST["111"]."\n";
fwrite($handle,$data);
}
if($_POST["112"] != "0.")
{
$data = "HiggsH1:etaParity = ".$_POST["112"]."\n";
fwrite($handle,$data);
}
if($_POST["113"] != "0.")
{
$data = "HiggsH1:phiParity = ".$_POST["113"]."\n";
fwrite($handle,$data);
}
if($_POST["114"] != "1")
{
$data = "HiggsH2:parity = ".$_POST["114"]."\n";
fwrite($handle,$data);
}
if($_POST["115"] != "0.")
{
