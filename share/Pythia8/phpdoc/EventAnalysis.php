...
<br/><code>argument</code><strong> precluster </strong> (<code>default = <strong>off</strong></code>) :  
...
<br/><code>argument</code><strong> reassign </strong> (<code>default = <strong>off</strong></code>) :  
...
<br/><code>argument</code><strong> useFJcore </strong> (<code>default = <strong>on</strong></code>) : choice of code used for finding 
the jets. Does not affect the outcome of the analysis, but only the speed, 
and some more specialized options. 
<br/><code>argumentoption </code><strong> on</strong> : use the <code>fjcore</code> package of 
<code>FastJet 3.0.5</code>. 
   
<br/><code>argumentoption </code><strong> off</strong> : use the native <code>SlowJet</code> implementation, 
which gives a slower jet finding, but allows some extra options of 
step-by-step jet joining. 
   
   
<br/><code>argument</code><strong> useStandardR </strong> (<code>default = <strong>on</strong></code>) : definition of <i>R</i> 
...
<br/><code>argumentoption </code><strong> on</strong> : standard, as described above, 
<i>DeltaR_ij^2 = (y_i - y_j)^2 + (phi_i - phi_j)^2.</i> 
   
<br/><code>argumentoption </code><strong> off</strong> : alternative, 
