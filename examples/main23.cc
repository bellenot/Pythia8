...
// It takes input from main23.cmnd and puts events on a HepMC file,
...
int main() {
  ...
  HepMC::IO_Ascii ascii_io("hepmcout23.dat",std::ios::out);
  // HepMC::IO_AsciiParticles ascii_io("hepmcout23.dat",std::ios::out);

  // Generator. 
  Pythia pythia;

  // Read in commands from external file.
  pythia.readFile("main23.cmnd");    
