...
// Process: h > b b~ HIG<=1 HIW<=1 QED<=1 @1

// Exception class
class PY8MEs_heft_h_bbxException : public exception
{
  virtual const char * what() const throw()
  {
    return "Exception in class 'PY8MEs_heft_h_bbx'."; 
  }
}
PY8MEs_heft_h_bbx_exception; 

std::set<int> PY8MEs_heft_h_bbx::s_channel_proc = std::set<int> (createset<int>
    ());

int PY8MEs_heft_h_bbx::helicities[ncomb][nexternal] = {{0, -1, -1}, {0, -1, 1},
    {0, 1, -1}, {0, 1, 1}};

// Normalization factors the various processes
// Denominators: spins, colors and identical particles
int PY8MEs_heft_h_bbx::denom_colors[nprocesses] = {1}; 
int PY8MEs_heft_h_bbx::denom_hels[nprocesses] = {1}; 
int PY8MEs_heft_h_bbx::denom_iden[nprocesses] = {1}; 

//--------------------------------------------------------------------------
// Color config initialization
void PY8MEs_heft_h_bbx::initColorConfigs() 
{
  color_configs = vector < vec_vec_int > (); 
  jamp_nc_relative_power = vector < vec_int > (); 

  // Color flows of process Process: h > b b~ HIG<=1 HIW<=1 QED<=1 @1
...
//--------------------------------------------------------------------------
// Destructor.
PY8MEs_heft_h_bbx::~PY8MEs_heft_h_bbx() 
{
...
vector<int> PY8MEs_heft_h_bbx::invert_mapping(vector<int> mapping) 
{
...
vector < vec_int > PY8MEs_heft_h_bbx::getHelicityConfigs(vector<int>
    permutation)
{
...
vector < vec_int > PY8MEs_heft_h_bbx::getColorConfigs(int specify_proc_ID,
...
int PY8MEs_heft_h_bbx::getColorFlowRelativeNCPower(int color_flow_ID, int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
vector<int> PY8MEs_heft_h_bbx::getHelicityConfigForID(int hel_ID, vector<int>
    permutation)
{
  if (hel_ID < 0 || hel_ID >= ncomb)
  {
    cerr <<  "Error in function 'getHelicityConfigForID' of class" << 
    " 'PY8MEs_heft_h_bbx': Specified helicity ID '" << 
    hel_ID <<  "' cannot be found." << endl; 
    throw PY8MEs_heft_h_bbx_exception; 
  }
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  {
...
int PY8MEs_heft_h_bbx::getHelicityIDForConfig(vector<int> hel_config,
    vector<int> permutation)
{
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  ...
  if (hel_config.size() > 0)
  {
    ...
    if (user_ihel == -1)
    {
      ...
      " 'PY8MEs_heft_h_bbx': Specified helicity" << 
...
vector<int> PY8MEs_heft_h_bbx::getColorConfigForID(int color_ID, int
    specify_proc_ID, vector<int> permutation)
{
  ...
  if (color_ID < 0 || color_ID >= int(color_configs[chosenProcID].size()))
  {
    ...
    " 'PY8MEs_heft_h_bbx': Specified color ID '" << 
...
int PY8MEs_heft_h_bbx::getColorIDForConfig(vector<int> color_config, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_config.size() > 0)
  {
      ...
      for (unsigned int j = 0; j < (nexternal * 2); j++ )
      {
        ...
        else
        {
          ...
          if (color_linked_pos == -1)
          {
            ...
            " 'PY8MEs_heft_h_bbx': A color line could " << 
            " not be closed." << endl; 
            throw PY8MEs_heft_h_bbx_exception; 
          }
    ...
    {
      cerr <<  "Error in function 'getColorIDForConfig' of class" << 
      " 'PY8MEs_heft_h_bbx': Specified color" << 
      " configuration cannot be found." << endl; 
      throw PY8MEs_heft_h_bbx_exception; 
    }
  }
...
vector < vec_double > PY8MEs_heft_h_bbx::getAllResults(int specify_proc_ID) 
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  {
...
double PY8MEs_heft_h_bbx::getResult(int helicity_ID, int color_ID, int
    specify_proc_ID)
{
...
pair < vector<int> , int > PY8MEs_heft_h_bbx::static_getPY8ME(vector<int>
...
//--------------------------------------------------------------------------
// Set momenta
void PY8MEs_heft_h_bbx::setMomenta(vector < vec_double > momenta_picked)
{
  if (momenta_picked.size() != nexternal)
  {
    cerr <<  "Error in function 'setMomenta' of class" << 
    " 'PY8MEs_heft_h_bbx': Incorrect number of" << 
  ...
  for(unsigned int i = 0; i < nexternal; i++ )
  {
    ...
    {
      cerr <<  "Error in function 'setMomenta' of class" << 
      " 'PY8MEs_heft_h_bbx': A momentum was specified" << 
...
void PY8MEs_heft_h_bbx::setColors(vector<int> colors_picked)
{
  ...
  if (colors_picked.size() != (2 * nexternal))
  {
    ...
    " 'PY8MEs_heft_h_bbx': Incorrect number" << 
...
void PY8MEs_heft_h_bbx::setHelicities(vector<int> helicities_picked) 
{
...
void PY8MEs_heft_h_bbx::setPermutation(vector<int> perm_picked) 
{
...
void PY8MEs_heft_h_bbx::setProcID(int procID_picked) 
{
...
void PY8MEs_heft_h_bbx::initProc() 
{
...
// parameters
void PY8MEs_heft_h_bbx::syncProcModelParams() 
{
...
void PY8MEs_heft_h_bbx::setMasses(vec_double external_masses) 
{
...
vector<double> PY8MEs_heft_h_bbx::getMasses() 
{
...
void PY8MEs_heft_h_bbx::setExternalMassesMode(int mode) 
{
  if (mode != 0 && mode != 1 && mode != 2)
  {
    cerr <<  "Error in function 'setExternalMassesMode' of class" << 
    " 'PY8MEs_heft_h_bbx': Incorrect mode selected :" << mode << 
...
double PY8MEs_heft_h_bbx::sigmaKin(bool LC) 
{
...
void PY8MEs_heft_h_bbx::calculate_wavefunctions(const int hel[])
{
...
double PY8MEs_heft_h_bbx::matrix_1_h_bbx() 
{
  int i, j; 
  // Local variables
  // const int ngraphs = 1;
