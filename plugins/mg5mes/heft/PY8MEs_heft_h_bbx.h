...
#ifndef PY8MEs_heft_h_bbx_H
#define PY8MEs_heft_h_bbx_H
...
class PY8MEs_heft_h_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_heft_h_bbx(Parameters_heft * model) : pars(model) {initProc();}
    ...
    virtual string name() const {return "h_bbx (heft)";}

    virtual int code() const {return 10104;}
