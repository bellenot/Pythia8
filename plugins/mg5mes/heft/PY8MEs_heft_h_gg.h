...
#ifndef PY8MEs_heft_h_gg_H
#define PY8MEs_heft_h_gg_H
...
class PY8MEs_heft_h_gg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_heft_h_gg(Parameters_heft * model) : pars(model) {initProc();}
    ...
    virtual string name() const {return "h_gg (heft)";}

    virtual int code() const {return 10103;}
