...
#ifndef PY8MEs_heft_h_gbbx_H
#define PY8MEs_heft_h_gbbx_H
...
class PY8MEs_heft_h_gbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_heft_h_gbbx(Parameters_heft * model) : pars(model) {initProc();}
    ...
    virtual string name() const {return "h_gbbx (heft)";}
