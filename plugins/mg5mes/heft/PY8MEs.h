...
#ifndef PY8MEs_H_heft
#define PY8MEs_H_heft
...
class PY8MEs
{
  public:
    ...
    // Constructors
    // Uncomment the lines below when enabling the use of the SA (i.e.
    // Stand-Alone, that is non-PY8) C++ model.
    PY8MEs(string param_card_path = string());
    // 

    PY8MEs(Parameters_heft * model_input); 
    // Destructor
    ~PY8MEs(); 
    ...
    // Uncomment the lines below when enabling the use of the SA (i.e.
    // Stand-Alone, that is non-PY8) C++ model.
    // static Parameters_heft* instantiateModel(string param_card_path =
    // string());
    // 
    ...
    // 
    // void initModelWithPY8(ParticleData * & pd, CoupSM * & csm,
    // SusyLesHouches * & slhaPtr);
    // void updateModelDependentCoupSMWithPY8(ParticleData * & pd, CoupSM * &
    ...
    Parameters_heft * getModel(bool changeReleaseModelOnExit = true) 
    {
    ...
    // originated
    // from outside.
    void setModel(Parameters_heft * model_input) 
    {
