...
#ifndef PY8MEs_heft_h_gqq_H
#define PY8MEs_heft_h_gqq_H
...
class PY8MEs_heft_h_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_heft_h_gqq(Parameters_heft * model) : pars(model) {initProc();}
    ...
    virtual double sigmaKin(bool LC = false); 

    // Info on the subprocess.
    virtual string name() const {return "h_gqq (heft)";}
    ...
    // Accessors
    Parameters_heft * getModel() {return pars;}
    void setModel(Parameters_heft * model) {pars = model;}
