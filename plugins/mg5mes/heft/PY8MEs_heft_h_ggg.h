...
#ifndef PY8MEs_heft_h_ggg_H
#define PY8MEs_heft_h_ggg_H
...
class PY8MEs_heft_h_ggg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_heft_h_ggg(Parameters_heft * model) : pars(model) {initProc();}
    ...
    virtual string name() const {return "h_ggg (heft)";}
