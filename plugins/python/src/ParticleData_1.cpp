...
{
	{ // Pythia8::ParticleData file:Pythia8/ParticleData.h line:405
		...
		cl.def("addParticle", (void (Pythia8::ParticleData::*)(int, std::string, int, int, int, double, double, double, double, double)) &Pythia8::ParticleData::addParticle, "C++: Pythia8::ParticleData::addParticle(int, std::string, int, int, int, double, double, double, double, double) --> void", pybind11::arg("idIn"), pybind11::arg("nameIn"), pybind11::arg("spinTypeIn"), pybind11::arg("chargeTypeIn"), pybind11::arg("colTypeIn"), pybind11::arg("m0In"), pybind11::arg("mWidthIn"), pybind11::arg("mMinIn"), pybind11::arg("mMaxIn"), pybind11::arg("tau0In"));
		...
		cl.def("addParticle", (void (Pythia8::ParticleData::*)(int, std::string, std::string, int, int, int, double, double, double, double, double)) &Pythia8::ParticleData::addParticle, "C++: Pythia8::ParticleData::addParticle(int, std::string, std::string, int, int, int, double, double, double, double, double) --> void", pybind11::arg("idIn"), pybind11::arg("nameIn"), pybind11::arg("antiNameIn"), pybind11::arg("spinTypeIn"), pybind11::arg("chargeTypeIn"), pybind11::arg("colTypeIn"), pybind11::arg("m0In"), pybind11::arg("mWidthIn"), pybind11::arg("mMinIn"), pybind11::arg("mMaxIn"), pybind11::arg("tau0In"));
		...
		cl.def("setAll", (void (Pythia8::ParticleData::*)(int, std::string, std::string, int, int, int, double, double, double, double, double)) &Pythia8::ParticleData::setAll, "C++: Pythia8::ParticleData::setAll(int, std::string, std::string, int, int, int, double, double, double, double, double) --> void", pybind11::arg("idIn"), pybind11::arg("nameIn"), pybind11::arg("antiNameIn"), pybind11::arg("spinTypeIn"), pybind11::arg("chargeTypeIn"), pybind11::arg("colTypeIn"), pybind11::arg("m0In"), pybind11::arg("mWidthIn"), pybind11::arg("mMinIn"), pybind11::arg("mMaxIn"), pybind11::arg("tau0In"));
		...
		cl.def("findParticle", (class Pythia8::ParticleDataEntry * (Pythia8::ParticleData::*)(int)) &Pythia8::ParticleData::findParticle, "C++: Pythia8::ParticleData::findParticle(int) --> class Pythia8::ParticleDataEntry *", pybind11::return_value_policy::automatic, pybind11::arg("idIn"));
		...
		cl.def("particleDataEntryPtr", (class Pythia8::ParticleDataEntry * (Pythia8::ParticleData::*)(int)) &Pythia8::ParticleData::particleDataEntryPtr, "C++: Pythia8::ParticleData::particleDataEntryPtr(int) --> class Pythia8::ParticleDataEntry *", pybind11::return_value_policy::automatic, pybind11::arg("idIn"));
