...
void bind_Pythia8_ParticleData(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::ParticleDataEntry file:Pythia8/ParticleData.h line:125
		...
		cl.def("setAll", (void (Pythia8::ParticleDataEntry::*)(std::string, std::string, int, int, int, double, double, double, double, double, double)) &Pythia8::ParticleDataEntry::setAll, "C++: Pythia8::ParticleDataEntry::setAll(std::string, std::string, int, int, int, double, double, double, double, double, double) --> void", pybind11::arg("nameIn"), pybind11::arg("antiNameIn"), pybind11::arg("spinTypeIn"), pybind11::arg("chargeTypeIn"), pybind11::arg("colTypeIn"), pybind11::arg("m0In"), pybind11::arg("mWidthIn"), pybind11::arg("mMinIn"), pybind11::arg("mMaxIn"), pybind11::arg("tau0In"), pybind11::arg("varWidthIn"));
