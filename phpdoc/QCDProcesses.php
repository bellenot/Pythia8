...
echo "<a href='MultipleInteractions.php?filepath=".$filepath."' target='page'>";?>
...
<i>A B -> A X</i>. See page on <?php $filepath = $_GET["filepath"];
...
is instead included as part of the multiple-interactions framework, 
