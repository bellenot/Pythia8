...
<a name="method11"></a>
<p/><strong>void Hist::table(ostream& os = cout, bool printOverUnder = false) &nbsp;</strong> <br/>
   
<strong>void Hist::table(string fileName, bool printOverUnder = false) &nbsp;</strong> <br/>
...
be a file of its own. The optional last arguments allows also underflow 
and overflow contents to be printed. (The arbitrary <i>x</i> coordinates 
for these are placed as if corresponding to same-size bins just below or 
above the regular histogram bins.) The table may be useful for plotting 
e.g. with Gnuplot. 
   
 
<a name="method12"></a>
<p/><strong>friend void table(const Hist& h1, const Hist& h2, ostream& os = cout, bool printOverUnder = false) &nbsp;</strong> <br/>
   
<strong>friend void table(const Hist& h1, const Hist& h2, string fileName, bool printOverUnder = false) &nbsp;</strong> <br/>
...
x axis (within a tiny tolerance), else nothing will be done. The optional 
last arguments allows also underflow and overflow contents to be printed. 
