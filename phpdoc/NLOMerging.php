...
<p/> NL<sup>3</sup> is a generalisation of <?php $filepath = $_GET["filepath"];
...
<i>&alpha;<sub>s</sub><sup>n+1</sup></i>-terms from this result, and add back
...
<i>pT<sub>jet</sub> = 5 GeV</i>, <i>&Delta;R<sub>jetA jetB</sub> = 
...
<br/><br/><table><tr><td><strong>Merging:nJetMaxNLO  </td><td></td><td> <input type="text" name="1" value="0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0</strong></code>; <code>minimum = 0</code>)</td></tr></table>
The maximal number of additional jets for which NLO event samples are 
supplied by the user.
  

<br/><br/><table><tr><td><strong>Merging:muFac </td><td></td><td> <input type="text" name="2" value="-1.0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>-1.0</strong></code>)</td></tr></table>
...
<br/><br/><table><tr><td><strong>Merging:muFacInME </td><td></td><td> <input type="text" name="4" value="-1.0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>-1.0</strong></code>)</td></tr></table>
...
<br/><br/><table><tr><td><strong>Merging:muRenInME </td><td></td><td> <input type="text" name="5" value="-1.0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>-1.0</strong></code>)</td></tr></table>
...
<p/> &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; 2. Produce reweighted tree-level events, 
     which do not contain <i>&alpha;<sub>s</sub><sup>0</sup></i>- and 
...
<br/><br/><table><tr><td><strong>Merging:kFactor0j </td><td></td><td> <input type="text" name="6" value="1.0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.0</strong></code>)</td></tr></table>
The k-Factor used to rescale the tree-level (i.e. CKKW-L or UMEPS) part of
zero-jet tree-level events.
  

<br/><br/><table><tr><td><strong>Merging:kFactor1j </td><td></td><td> <input type="text" name="7" value="1.0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.0</strong></code>)</td></tr></table>
The k-Factor used to rescale the tree-level (i.e. CKKW-L or UMEPS) part of
one-jet tree-level events.
  

<br/><br/><table><tr><td><strong>Merging:kFactor2j </td><td></td><td> <input type="text" name="8" value="1.0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.0</strong></code>)</td></tr></table>
The k-Factor used to rescale the tree-level (i.e. CKKW-L or UMEPS) part of
...
accuracy, and with <i>W+&le;4 jets</i> at tree-level accuracy, then  
...
<br/><br/><strong>Merging:doNL3Tree</strong>  <input type="radio" name="9" value="on"><strong>On</strong>
...
<br/><br/><strong>Merging:doNL3Loop</strong>  <input type="radio" name="10" value="on"><strong>On</strong>
...
<br/><br/><strong>Merging:doNL3Subt</strong>  <input type="radio" name="11" value="on"><strong>On</strong>
...
<br/><br/><strong>Merging:doUNLOPSTree</strong>  <input type="radio" name="12" value="on"><strong>On</strong>
...
<br/><br/><strong>Merging:doUNLOPSLoop</strong>  <input type="radio" name="13" value="on"><strong>On</strong>
...
<br/><br/><strong>Merging:doUNLOPSSubt</strong>  <input type="radio" name="14" value="on"><strong>On</strong>
...
<br/><br/><strong>Merging:doUNLOPSSubtNLO</strong>  <input type="radio" name="15" value="on"><strong>On</strong>
...
if($_POST["1"] != "0")
{
$data = "Merging:nJetMaxNLO = ".$_POST["1"]."\n";
fwrite($handle,$data);
}
if($_POST["2"] != "-1.0")
{
$data = "Merging:muFac = ".$_POST["2"]."\n";
fwrite($handle,$data);
}
if($_POST["3"] != "-1.0")
{
$data = "Merging:muRen = ".$_POST["3"]."\n";
fwrite($handle,$data);
}
if($_POST["4"] != "-1.0")
{
$data = "Merging:muFacInME = ".$_POST["4"]."\n";
fwrite($handle,$data);
}
if($_POST["5"] != "-1.0")
{
$data = "Merging:muRenInME = ".$_POST["5"]."\n";
fwrite($handle,$data);
}
if($_POST["6"] != "1.0")
{
$data = "Merging:kFactor0j = ".$_POST["6"]."\n";
fwrite($handle,$data);
}
if($_POST["7"] != "1.0")
{
$data = "Merging:kFactor1j = ".$_POST["7"]."\n";
fwrite($handle,$data);
}
if($_POST["8"] != "1.0")
{
$data = "Merging:kFactor2j = ".$_POST["8"]."\n";
fwrite($handle,$data);
}
if($_POST["9"] != "off")
{
$data = "Merging:doNL3Tree = ".$_POST["9"]."\n";
fwrite($handle,$data);
}
if($_POST["10"] != "off")
{
$data = "Merging:doNL3Loop = ".$_POST["10"]."\n";
fwrite($handle,$data);
}
if($_POST["11"] != "off")
{
$data = "Merging:doNL3Subt = ".$_POST["11"]."\n";
fwrite($handle,$data);
}
if($_POST["12"] != "off")
{
$data = "Merging:doUNLOPSTree = ".$_POST["12"]."\n";
fwrite($handle,$data);
}
if($_POST["13"] != "off")
{
$data = "Merging:doUNLOPSLoop = ".$_POST["13"]."\n";
fwrite($handle,$data);
}
if($_POST["14"] != "off")
{
$data = "Merging:doUNLOPSSubt = ".$_POST["14"]."\n";
fwrite($handle,$data);
}
if($_POST["15"] != "off")
{
$data = "Merging:doUNLOPSSubtNLO = ".$_POST["15"]."\n";
fwrite($handle,$data);
}
if($_POST["16"] != "off")
{
$data = "Merging:doUNLOPSTilde = ".$_POST["16"]."\n";
fwrite($handle,$data);
}
fclose($handle);
}
