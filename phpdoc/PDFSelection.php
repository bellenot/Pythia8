...
The third gives the possibility to switch off the electron 
"parton density". 
...
The <code>main31.cc</code> and <code>main32.cc</code> programs in the 
...
<br/><br/><table><tr><td><strong>Pythia:pPDFset  </td><td>  &nbsp;&nbsp;(<code>default = <strong>2</strong></code>; <code>minimum = 1</code>; <code>maximum = 2</code>)</td></tr></table>
<modepick name="Pythia:pPDFset" default="2" min="1" max="2">
...
<br/><br/><strong>Pythia:useLHAPDF</strong>  <input type="radio" name="2" value="on"><strong>On</strong>
...
<br/><br/><table><tr><td><strong>Pythia:LHAPDFset  </td><td></td><td> <input type="text" name="3" value="MRST2004FF4lo.LHgrid" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>MRST2004FF4lo.LHgrid</strong></code>)</td></tr></table>
...
<br/><br/><table><tr><td><strong>Pythia:LHAPDFmember  </td><td></td><td> <input type="text" name="4" value="0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0</strong></code>; <code>minimum = 0</code>)</td></tr></table>
...
<br/><br/><strong>Pythia:limitLHAPDF</strong>  <input type="radio" name="5" value="on" checked="checked"><strong>On</strong>
<input type="radio" name="5" value="off"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>on</strong></code>)<br/>
If on then you can set <i>x</i> and <i>Q2</i> limits below.
  

<br/><br/><table><tr><td><strong>Pythia:xMinLHAPDF </td><td></td><td> <input type="text" name="6" value="1e-6" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1e-6</strong></code>)</td></tr></table>
Freeze <i>x f_i(x, Q2)</i> below this <i>x</i> value.
  

<br/><br/><table><tr><td><strong>Pythia:xMaxLHAPDF </td><td></td><td> <input type="text" name="7" value="0.9999" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.9999</strong></code>)</td></tr></table>
Set <i>x f_i(x, Q2) = 0</i> above this <i>x</i> value.
  

<br/><br/><table><tr><td><strong>Pythia:Q2MinLHAPDF </td><td></td><td> <input type="text" name="8" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
Freeze <i>x f_i(x, Q2)</i> below this <i>Q2</i> value.
  

<br/><br/><table><tr><td><strong>Pythia:Q2MaxLHAPDF </td><td></td><td> <input type="text" name="9" value="1e8" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1e8</strong></code>)</td></tr></table>
...
<br/><br/><strong>Pythia:useHardPFD</strong>  <input type="radio" name="10" value="on"><strong>On</strong>
...
<br/><br/><table><tr><td><strong>Pythia:hardpPDFset  </td><td>  &nbsp;&nbsp;(<code>default = <strong>2</strong></code>; <code>minimum = 1</code>; <code>maximum = 2</code>)</td></tr></table>
<modepick name="Pythia:hardpPDFset" default="2" min="1" max="2">
Parton densities to be used for proton beams (and, by implication,
antiproton ones):
<br/>
...
<br/><br/><strong>Pythia:useHardLHAPDF</strong>  <input type="radio" name="12" value="on"><strong>On</strong>
...
<br/><br/><table><tr><td><strong>Pythia:hardLHAPDFset  </td><td></td><td> <input type="text" name="13" value="MRST2004FF4lo.LHgrid" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>MRST2004FF4lo.LHgrid</strong></code>)</td></tr></table>
Name of proton PDF set from LHAPDF to be used. 
   

<br/><br/><table><tr><td><strong>Pythia:hardLHAPDFmember  </td><td></td><td> <input type="text" name="14" value="0" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0</strong></code>; <code>minimum = 0</code>)</td></tr></table>
Further choice of a specific member from the set picked above. 
</modeopen>   

<br/><br/><strong>Pythia:limitHardLHAPDF</strong>  <input type="radio" name="15" value="on" checked="checked"><strong>On</strong>
<input type="radio" name="15" value="off"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>on</strong></code>)<br/>
If on then you can set <i>x</i> and <i>Q2</i> limits below.
  

<br/><br/><table><tr><td><strong>Pythia:xMinHardLHAPDF </td><td></td><td> <input type="text" name="16" value="1e-6" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1e-6</strong></code>)</td></tr></table>
Freeze <i>x f_i(x, Q2)</i> below this <i>x</i> value.
  

<br/><br/><table><tr><td><strong>Pythia:xMaxHardLHAPDF </td><td></td><td> <input type="text" name="17" value="0.9999" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>0.9999</strong></code>)</td></tr></table>
Set <i>x f_i(x, Q2) = 0</i> above this <i>x</i> value.
  

<br/><br/><table><tr><td><strong>Pythia:Q2MinHardLHAPDF </td><td></td><td> <input type="text" name="18" value="1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1.</strong></code>)</td></tr></table>
Freeze <i>x f_i(x, Q2)</i> below this <i>Q2</i> value.
  

<br/><br/><table><tr><td><strong>Pythia:Q2MaxHardLHAPDF </td><td></td><td> <input type="text" name="19" value="1e8" size="20"/>  &nbsp;&nbsp;(<code>default = <strong>1e8</strong></code>)</td></tr></table>
Freeze <i>x f_i(x, Q2)</i> above this <i>Q2</i> value.
...
<br/><br/><strong>Pythia:lPDF</strong>  <input type="radio" name="20" value="on" checked="checked"><strong>On</strong>
...
if($_POST["1"] != "2")
{
$data = "Pythia:pPDFset = ".$_POST["1"]."\n";
fwrite($handle,$data);
}
if($_POST["2"] != "off")
{
$data = "Pythia:useLHAPDF = ".$_POST["2"]."\n";
fwrite($handle,$data);
}
if($_POST["3"] != "MRST2004FF4lo.LHgrid")
{
$data = "Pythia:LHAPDFset = ".$_POST["3"]."\n";
fwrite($handle,$data);
}
if($_POST["4"] != "0")
{
$data = "Pythia:LHAPDFmember = ".$_POST["4"]."\n";
fwrite($handle,$data);
}
if($_POST["5"] != "on")
{
$data = "Pythia:limitLHAPDF = ".$_POST["5"]."\n";
fwrite($handle,$data);
}
if($_POST["6"] != "1e-6")
{
$data = "Pythia:xMinLHAPDF = ".$_POST["6"]."\n";
fwrite($handle,$data);
}
if($_POST["7"] != "0.9999")
{
$data = "Pythia:xMaxLHAPDF = ".$_POST["7"]."\n";
fwrite($handle,$data);
}
if($_POST["8"] != "1.")
{
$data = "Pythia:Q2MinLHAPDF = ".$_POST["8"]."\n";
fwrite($handle,$data);
}
if($_POST["9"] != "1e8")
{
$data = "Pythia:Q2MaxLHAPDF = ".$_POST["9"]."\n";
fwrite($handle,$data);
}
if($_POST["10"] != "off")
{
$data = "Pythia:useHardPFD = ".$_POST["10"]."\n";
fwrite($handle,$data);
}
if($_POST["11"] != "2")
{
$data = "Pythia:hardpPDFset = ".$_POST["11"]."\n";
fwrite($handle,$data);
}
if($_POST["12"] != "off")
{
$data = "Pythia:useHardLHAPDF = ".$_POST["12"]."\n";
fwrite($handle,$data);
}
if($_POST["13"] != "MRST2004FF4lo.LHgrid")
{
$data = "Pythia:hardLHAPDFset = ".$_POST["13"]."\n";
fwrite($handle,$data);
}
if($_POST["14"] != "0")
{
$data = "Pythia:hardLHAPDFmember = ".$_POST["14"]."\n";
fwrite($handle,$data);
}
if($_POST["15"] != "on")
{
$data = "Pythia:limitHardLHAPDF = ".$_POST["15"]."\n";
fwrite($handle,$data);
}
if($_POST["16"] != "1e-6")
{
$data = "Pythia:xMinHardLHAPDF = ".$_POST["16"]."\n";
fwrite($handle,$data);
}
if($_POST["17"] != "0.9999")
{
$data = "Pythia:xMaxHardLHAPDF = ".$_POST["17"]."\n";
fwrite($handle,$data);
}
if($_POST["18"] != "1.")
{
$data = "Pythia:Q2MinHardLHAPDF = ".$_POST["18"]."\n";
fwrite($handle,$data);
}
if($_POST["19"] != "1e8")
{
$data = "Pythia:Q2MaxHardLHAPDF = ".$_POST["19"]."\n";
fwrite($handle,$data);
}
if($_POST["20"] != "on")
{
$data = "Pythia:lPDF = ".$_POST["20"]."\n";
fwrite($handle,$data);
}
fclose($handle);
}
