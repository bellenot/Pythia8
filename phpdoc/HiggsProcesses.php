...
within a more specific framework such as MSSM. One choice can be made 
...
This flag is used both for SM and BSM Higgses, and for the 
latter is extended also to apply to decays to other Higgses.
...
<br/><br/><strong>HiggsSM:all</strong>  <input type="radio" name="2" value="on"><strong>On</strong>
<input type="radio" name="2" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
Common switch for the group of Higgs production within the Standard Model.
  

<br/><br/><strong>HiggsSM:ffbar2H</strong>  <input type="radio" name="3" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:gg2H</strong>  <input type="radio" name="4" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:gmgm2H</strong>  <input type="radio" name="5" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:ffbar2HZ</strong>  <input type="radio" name="6" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:ffbar2HW</strong>  <input type="radio" name="7" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:ff2Hff(t:ZZ)</strong>  <input type="radio" name="8" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:ff2Hff(t:WW)</strong>  <input type="radio" name="9" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:gg2Httbar</strong>  <input type="radio" name="10" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:qqbar2Httbar</strong>  <input type="radio" name="11" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:qg2Hq</strong>  <input type="radio" name="12" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:gg2Hbbbar</strong>  <input type="radio" name="13" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:gg2Hg(l:t)</strong>  <input type="radio" name="15" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:qg2Hq(l:t)</strong>  <input type="radio" name="16" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsSM:qqbar2Hg(l:t)</strong>  <input type="radio" name="17" value="on"><strong>On</strong>
...
<br/><br/><strong>Higgs:useBSM</strong>  <input type="radio" name="18" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:allH1</strong>  <input type="radio" name="20" value="on"><strong>On</strong>
...
<br/><br/><strong>HiggsBSM:ffbar2H1</strong>  <input type="radio" name="21" value="on"><strong>On</strong>
...
if($_POST["2"] != "off")
{
$data = "HiggsSM:all = ".$_POST["2"]."\n";
fwrite($handle,$data);
}
if($_POST["3"] != "off")
{
$data = "HiggsSM:ffbar2H = ".$_POST["3"]."\n";
fwrite($handle,$data);
}
if($_POST["4"] != "off")
{
$data = "HiggsSM:gg2H = ".$_POST["4"]."\n";
fwrite($handle,$data);
}
if($_POST["5"] != "off")
{
$data = "HiggsSM:gmgm2H = ".$_POST["5"]."\n";
fwrite($handle,$data);
}
if($_POST["6"] != "off")
{
$data = "HiggsSM:ffbar2HZ = ".$_POST["6"]."\n";
fwrite($handle,$data);
}
if($_POST["7"] != "off")
{
$data = "HiggsSM:ffbar2HW = ".$_POST["7"]."\n";
fwrite($handle,$data);
}
if($_POST["8"] != "off")
{
$data = "HiggsSM:ff2Hff(t:ZZ) = ".$_POST["8"]."\n";
fwrite($handle,$data);
}
if($_POST["9"] != "off")
{
$data = "HiggsSM:ff2Hff(t:WW) = ".$_POST["9"]."\n";
fwrite($handle,$data);
}
if($_POST["10"] != "off")
{
$data = "HiggsSM:gg2Httbar = ".$_POST["10"]."\n";
fwrite($handle,$data);
}
if($_POST["11"] != "off")
{
$data = "HiggsSM:qqbar2Httbar = ".$_POST["11"]."\n";
fwrite($handle,$data);
}
if($_POST["12"] != "off")
{
$data = "HiggsSM:qg2Hq = ".$_POST["12"]."\n";
fwrite($handle,$data);
}
if($_POST["13"] != "off")
{
$data = "HiggsSM:gg2Hbbbar = ".$_POST["13"]."\n";
fwrite($handle,$data);
}
if($_POST["14"] != "off")
{
$data = "HiggsSM:qqbar2Hbbbar = ".$_POST["14"]."\n";
fwrite($handle,$data);
}
if($_POST["15"] != "off")
{
$data = "HiggsSM:gg2Hg(l:t) = ".$_POST["15"]."\n";
fwrite($handle,$data);
}
if($_POST["16"] != "off")
{
$data = "HiggsSM:qg2Hq(l:t) = ".$_POST["16"]."\n";
fwrite($handle,$data);
}
if($_POST["17"] != "off")
{
$data = "HiggsSM:qqbar2Hg(l:t) = ".$_POST["17"]."\n";
fwrite($handle,$data);
}
if($_POST["18"] != "off")
{
$data = "Higgs:useBSM = ".$_POST["18"]."\n";
fwrite($handle,$data);
}
if($_POST["19"] != "off")
{
$data = "HiggsBSM:all = ".$_POST["19"]."\n";
fwrite($handle,$data);
}
if($_POST["20"] != "off")
{
$data = "HiggsBSM:allH1 = ".$_POST["20"]."\n";
fwrite($handle,$data);
}
if($_POST["21"] != "off")
{
$data = "HiggsBSM:ffbar2H1 = ".$_POST["21"]."\n";
fwrite($handle,$data);
}
if($_POST["22"] != "off")
{
