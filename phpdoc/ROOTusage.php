...
events as ROOT trees. This is illustrated in the <code>rootexamples</code> 
subdirectory. 

<p/>
The files there are 
<ul>
<li><code>README</code> explains how to link PYTHIA and ROOT, and run the
example main programs.</li>
<li><code>Makefile</code> is used to build the two examples below,
and to build a dictionary.</li>
<li><code>hist.cc</code> is an example main program how ROOT can be used 
for histogramming without any direct link between PYTHIA and ROOT.</li>
<li><code>tree.cc</code> is an example main program how PYTHIA events
can be stored as ROOT trees.</li>
...
<code>pythia8150</code> (or newer) installation directory, and</li>
