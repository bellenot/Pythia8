...
<li>
 PYTHIA has not been written for threadsafe execution. You should 
never have more than one <code>Pythia</code> object in an executable
...
<p/>
As a consequence, it is not possible to generate signal and pileup
events simultaneously, by using one <code>Pythia</code> object for each.
Instead you may need to store events on disk, in two separate files, 
and mix afterwards.
</li>
