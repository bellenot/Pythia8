...
<br/><br/>
The <code>examples/main32.cc</code> sample program can then be used to
generate events in HepMC format. When in the <code>examples</code>
directory, the main program can be built and used as follows
<pre>
  make main32
  ./main32 main32.cmnd main32.hepmc
</pre>
...
<pre>
  rivet --analysis=ANALYSIS_NAME main32.hepmc
</pre>
...
<pre>
  mkfifo my_fifo
  ./main32.exe main32.cmnd my_fifo &
  rivet --analysis=ANALYSIS_NAME my_fifo
</pre>
Note that <code>main32</code> is run in the background.
