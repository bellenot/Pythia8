...
<p/><strong>void Event::list(ostream& os = cout) &nbsp;</strong> <br/>
  
<strong>void Event::list(bool showScaleAndVertex, bool showMothersAndDaughters = false, ostream& os = cout) &nbsp;</strong> <br/>
Provide a listing of the whole event, i.e. of the 
<code>vector&lt;Particle&gt;</code>. The basic identity code, status, 
mother, daughter, colour, four-momentum and mass data are always given, 
but the methods can also be called with a few optional arguments for 
further information:
