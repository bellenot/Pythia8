...
<br/><br/><strong>PartonLevel:earlyResDec</strong>  <input type="radio" name="9" value="on"><strong>On</strong>
...
<br/><br/><strong>PartonLevel:Remnants</strong>  <input type="radio" name="10" value="on" checked="checked"><strong>On</strong>
...
<br/><br/><strong>HadronLevel:all</strong>  <input type="radio" name="11" value="on" checked="checked"><strong>On</strong>
...
<br/><br/><strong>HadronLevel:Hadronize</strong>  <input type="radio" name="12" value="on" checked="checked"><strong>On</strong>
...
if($_POST["9"] != "off")
{
$data = "PartonLevel:earlyResDec = ".$_POST["9"]."\n";
fwrite($handle,$data);
}
if($_POST["10"] != "on")
{
$data = "PartonLevel:Remnants = ".$_POST["10"]."\n";
fwrite($handle,$data);
}
if($_POST["11"] != "on")
{
$data = "HadronLevel:all = ".$_POST["11"]."\n";
fwrite($handle,$data);
}
if($_POST["12"] != "on")
{
