...
<a name="method3"></a>
<p/><strong>static bool Rndm::rndmEnginePtr( RndmEngine* rndmPtr) &nbsp;</strong> <br/>
pass in pointer for external random number generation.
  
   
<a name="method4"></a>
<p/><strong>static void Rndm::init(int seed = 0) &nbsp;</strong> <br/>
...
<a name="method5"></a>
<p/><strong>static double Rndm::flat() &nbsp;</strong> <br/>
generate next random number uniformly between 0 and 1.
  
   
<a name="method6"></a>
<p/><strong>static double Rndm::exp() &nbsp;</strong> <br/>
generate random numbers according to <i>exp(-x)</i>.
  
   
<a name="method7"></a>
<p/><strong>static double Rndm::xexp() &nbsp;</strong> <br/>
generate random numbers according to <i>x exp(-x)</i>.
  
   
<a name="method8"></a>
<p/><strong>static double Rndm::gauss() &nbsp;</strong> <br/>
generate random numbers according to exp(-x^2/2)
  
   
<a name="method9"></a>
<p/><strong>static int Rndm::pick(const vector<double>& prob) &nbsp;</strong> <br/>
pick one option among vector of (positive) probabilities.
  
   
<a name="method10"></a>
<p/><strong>static bool Rndm::dumpState(string fileName) &nbsp;</strong> <br/>
...
<a name="method11"></a>
<p/><strong> static bool Rndm::readState(string fileName) &nbsp;</strong> <br/>
...
(or generator interface) then you must impement this method 
