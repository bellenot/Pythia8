...
<p/>
The <code>Pythia</code> class defines a flag and a mode, that allows 
the <code>seed</code> to be set in the <code>Pythia::init</code> call. 
That would be the standard way for a user to the pick random number 
sequence in a run.
...
generator is provided in <code>main18.cc</code>.
