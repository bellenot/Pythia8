...
This Hidden Valley (HV) scenario is hardly even begun. Please do not 
read any further if you are not part of the development effort.
...
<input type="radio" name="30" value="off" checked="checked"><strong>Off</strong>
 &nbsp;&nbsp;(<code>default = <strong>off</strong></code>)<br/>
switch on final-state shower of gluons in a HV production process.
...
fixed alpha scale of gHV emission; corresponds to 
<i>alpha_strong</i> of QCD. For shower branchings such as
<i>dHV -> dHV + gHV</i> the coupling is multiplied
by <i>C_F = (N^2 - 1) / (2 * N)</i> for an <b>SU(N)</b> group.
