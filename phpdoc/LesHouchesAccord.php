...
<br/>
<input type="radio" name="1" value="0"><strong>0 </strong>:  all decay times are taken from the Les Houches input. <br/>
<input type="radio" name="1" value="1" checked="checked"><strong>1 </strong>:  the decay time of <ei>tau</ei> leptons is generated like for internal PYTHIA <ei>tau</ei>s, whereas all other decay times  are taken from the Les Houches input. <br/>
<input type="radio" name="1" value="2"><strong>2 </strong>:  all decay times are generated by PYTHIA, thus completely disregarding the Les Houches values. This option could  go wrong in BSM scenarios with long-lived particles, if PYTHIA  has not been provided with the information to select those lifetimes  correctly.  <br/>
...
<br/><br/><table><tr><td><strong>LesHouches:mRecalculate </td><td></td><td> <input type="text" name="2" value="-1." size="20"/>  &nbsp;&nbsp;(<code>default = <strong>-1.</strong></code>)</td></tr></table>
...
if($_POST["1"] != "1")
{
$data = "LesHouches:setLifetime = ".$_POST["1"]."\n";
fwrite($handle,$data);
}
if($_POST["2"] != "-1.")
{
$data = "LesHouches:mRecalculate = ".$_POST["2"]."\n";
fwrite($handle,$data);
}
fclose($handle);
}
